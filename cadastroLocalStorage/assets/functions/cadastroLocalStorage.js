...
/** Capturando os dados através do ID de cada Input do form */
...
//  if(uf == ['AC','AL','AP','AM','BA','CE','DF','ES','GO','MA','MT','MS','MG','PA','PB','PR','PE','PI','RJ','RN','RS','RO','RR','SC','SP','SE','TO']){
//     return true;
//  }else{
//     alert("Por favor, preencha o UF corretamente!");
// }
